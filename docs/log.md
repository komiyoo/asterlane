...
- **Requirements**: Added `product-requirements.md` to preserve the original Asterlane product intent, non-goals, key scope model, MCP naming convention, progressive disclosure requirements, and observability expectations.
